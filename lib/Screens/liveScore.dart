        ...
        itemBuilder: (context, index) {
          return Padding(
            ...
            child: Container(
              ...
              child: ListTile(
                title: Text(liveScores[index].name, style: TextStyle(fontWeight: FontWeight.bold),),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(liveScores[index].status, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),),
                    Text(liveScores[index].matchType),
                  ],
                ),
